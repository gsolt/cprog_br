...
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
nReteszNum = 9;         /* Reteszes TMOK-k száma */
...
dpPars[7].nSite   = 3;       /* TMOK: G: 31-63, H: Bicske 041/8  */
dpPars[7].nDP_ID  = 1289;    /* DP6, 29. */

dpPars[8].nSite   = 3;       /* TMOK: G: 34-04, H: Bicske 041/8  */
dpPars[8].nDP_ID  = 1291;    /* DP6, 29. */
